...
public class NowPlaying {
    ...
    /**
     * method to construct ur for the particular request.
     * @param pApiKey
     * @param pBasePath
     * @param pPage
     * @param pId
     * @return
     */
    public String constructURL( String pApiKey, String pBasePath, String pPage, String pId)
    {
        //Sample URL  https://api.themoviedb.org/3/movie/now_playing?api_key=461e99d35de36a0e9680f40b1b06073c&page=1

        Log.d("ConstructedURL",pBasePath+pId+ Constants.API_PREFIX+pApiKey+"&"+pPage);
        return pBasePath+pId+ Constants.API_PREFIX+pApiKey+"&"+pPage;
